...
abstract class $WorkoutRouteCopyWith<$Res> {
  factory $WorkoutRouteCopyWith(
    WorkoutRoute value,
    $Res Function(WorkoutRoute) then,
  ) = _$WorkoutRouteCopyWithImpl<$Res, WorkoutRoute>;
  @useResult
  $Res call({
    String uuid,
    @JsonKey(name: 'route_data') List<ExtendedPos> routeData,
  });
}
...
class _$WorkoutRouteCopyWithImpl<$Res, $Val extends WorkoutRoute>
  ...
  @override
  $Res call({Object? uuid = null, Object? routeData = null}) {
    return _then(
      _value.copyWith(
            uuid:
                null == uuid
...
abstract class _$$WorkoutRouteImplCopyWith<$Res>
  ...
  factory _$$WorkoutRouteImplCopyWith(
    _$WorkoutRouteImpl value,
    $Res Function(_$WorkoutRouteImpl) then,
...
class __$$WorkoutRouteImplCopyWithImpl<$Res>
  ...
  __$$WorkoutRouteImplCopyWithImpl(
    _$WorkoutRouteImpl _value,
    $Res Function(_$WorkoutRouteImpl) _then,
  ) : super(_value, _then);
...
/// @nodoc
@JsonSerializable()
class _$WorkoutRouteImpl implements _WorkoutRoute {
  ...
  int get hashCode => Object.hash(
    runtimeType,
    uuid,
    const DeepCollectionEquality().hash(_routeData),
  );
  ...
  Map<String, dynamic> toJson() {
    return _$$WorkoutRouteImplToJson(this);
  }
}
