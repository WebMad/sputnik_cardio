...
abstract class $ExtendedPosCopyWith<$Res> {
  factory $ExtendedPosCopyWith(
          ExtendedPos value, $Res Function(ExtendedPos) then) =
...
abstract class _$$ExtendedPosImplCopyWith<$Res>
  ...
  factory _$$ExtendedPosImplCopyWith(
          _$ExtendedPosImpl value, $Res Function(_$ExtendedPosImpl) then) =
...
class __$$ExtendedPosImplCopyWithImpl<$Res>
  ...
  $Res call({
    ...
    return _then(_$ExtendedPosImpl(
      lat: null == lat
          ? _value.lat
          : lat // ignore: cast_nullable_to_non_nullable
              as double,
...
/// @nodoc
@JsonSerializable()
class _$ExtendedPosImpl with DiagnosticableTreeMixin implements _ExtendedPos {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
      ..add(DiagnosticsProperty('type', 'ExtendedPos'))
      ..add(DiagnosticsProperty('lat', lat))
      ..add(DiagnosticsProperty('lon', lon))
      ..add(DiagnosticsProperty('alt', alt))
      ..add(DiagnosticsProperty('fetchedAt', fetchedAt));
  }
  ...
  Map<String, dynamic> toJson() {
    return _$$ExtendedPosImplToJson(
      this,
    );
  }
}
